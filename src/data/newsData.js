...
export const newsArticles = [
  {
    ...
    title:
      "Ipaja-Ayobo LG Chairman Boosts Neighborhood Watch Morale with Vehicle Donations",
    excerpt:
      "Hon. Abiodun Agbaje empowers local security volunteers with new patrol vehicles and equipment to enhance community safety.",
    content: `Ipaja-Ayobo Local Government Chairman, Hon. Abiodun Agabje, has demonstrated his commitment to community security by donating five brand new patrol vehicles to the local neighborhood watch group. The donation ceremony, held at the council secretariat, was attended by community leaders, security officials, and residents who expressed their appreciation for the government's support.
...
The vehicles, equipped with modern communication gadgets and safety equipment, will significantly enhance the group's ability to patrol various communities within the local government. Chairman Alimi emphasized that security remains a top priority of his administration and promised continuous support for all security initiatives.`,
  ...
  },
  {
    ...
    content: `The Ipaja-Ayobo Stadium was electrifying yesterday as Young Starz FC claimed the Bet9ja Youth League title, capping off an intense season of grassroots football. The deciding match against Dynamite United was a fiercely contested affair, ending 2-1 in favor of the Starz.
...
Participants will receive six months of intensive training followed by starter packs to help them establish their own businesses. The chairman noted that this initiative is part of his administration's broader strategy to invest in human capital development and create economic opportunities at the grassroots level.`,
  ...
  },
  {
    ...
    title: "Free Medical Outreach Reaches 2,000 Ipaja-Ayobo Residents",
    excerpt:
      "Local government partners with healthcare providers to offer free medical services to underserved communities.",
    content: `A three-day free medical outreach organized by Ipaja-Ayobo Local Government has provided healthcare services to over 2,000 residents. The program, which took place at the council's primary healthcare center, offered free medical consultations, laboratory tests, and medications for common ailments.
...
Residents have expressed their satisfaction with the quality of work, noting that the improved road network has reduced travel time and vehicle maintenance costs. The local government engineer confirmed that regular maintenance schedules have been established to ensure the roads remain in good condition.`,
  ...
  },
  {
    ...
    title:
      "Monthly Environmental Sanitation Records 85% Compliance in Ipaja-Ayobo",
    excerpt:
      "Residents demonstrate strong commitment to cleanliness as local government enforces environmental laws.",
    content: `The recent monthly environmental sanitation exercise in Ipaja-Ayobo Local Government recorded an impressive 85% compliance rate, according to officials. The exercise, which restricted movement between 7am and 10am, allowed residents to clean their surroundings and dispose of waste properly.
